                ...
                <div id="reminderBlock">
                    <form>
                        ...
                        <br/>
                            ...
                            <input className="reminderInput" type="number" min="0" max="48" placeholder=""></input> <label>hrs</label>
                            <br/>
                            <input className="reminderInput" type="number" min="0" max="48" placeholder=""></input> <label>min</label>
                            <br/>
                        <button type="submit" id="setBtn" className="close">Set</button>
                    </form>
                </div>
            </div>
...
class Popup extends React.Component {
    ...
    selectTab = (event) => {
        ...
        chrome.runtime.sendMessage(["select", tabId, urlTemp])
    }
